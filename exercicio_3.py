...
if cromossomo == "chr17" and 41196312 <= posição <= 41277500 and genoma_referencia == "hg19":
    print("Sim")
elif cromossomo == "chr17" and 43044295 <= posição <= 43125483 and genoma_referencia == "hg38":
    print("Sim")
else:
    print("Não")
